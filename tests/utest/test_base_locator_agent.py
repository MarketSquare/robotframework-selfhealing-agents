...
MODULE_PATH: str = (
    "SelfhealingAgents.self_healing_system.agents.locator_agent.base_locator_agent"
)
...
def _install_stubs() -> _LoggerStub:
    ...
    prompts_pkg = types.ModuleType(
        "SelfhealingAgents.self_healing_system.agents.prompts.locator.prompts_locator"
    )
    ...
    client_model = types.ModuleType(
        "SelfhealingAgents.self_healing_system.llm.client_model"
    )
    ...
    _force_module(
        "SelfhealingAgents.self_healing_system.llm.client_model", client_model
    )

    loc_schema = types.ModuleType(
    ...
    _force_module(
        "SelfhealingAgents.self_healing_system.schemas.api.locator_healing", loc_schema
    )

    payload_mod = types.ModuleType(
    ...
    base_dom = types.ModuleType(
        "SelfhealingAgents.self_healing_system.context_retrieving.library_dom_utils.base_dom_utils"
    )
